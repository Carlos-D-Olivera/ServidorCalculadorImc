package carlosdolivera.imc.servidor;

import carlosdolivera.imc.vistas.VentanaPrincipal;
    ...
    public void iniciarServicio() {
        try {
            ...
            while (estado) {
                ...
                System.out.println(msg + "\n");
                ventana.getCajaLog().append(msg + "\n");
                SubProcesoCliente atencion = new SubProcesoCliente(ventana, cliente);
    ...
    public void detenerServicio() {
        if (estado) {
            ...
            try {
                ...
                System.out.println("Error no se puede cerrar el Puerto " +
                        puerto);
                String msg = log()+"Error no se puede cerrar el Puerto " +
                        puerto;
                System.out.println(msg);
                ventana.getCajaLog().append(msg + "\n");
            }
